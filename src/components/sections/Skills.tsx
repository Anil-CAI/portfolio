...
export default function Skills() {
  return (
    <SectionBackground backgroundImage="/assets/backgrounds/bg.jpg" overlayOpacity={0.7}>
      <section id="skills" className="border-y border-border py-24 md:py-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {skillCategories.map((category, idx) => (
              <motion.div
                ...
                className="bg-washi border border-border rounded-xl p-6 md:p-8 relative overflow-hidden group transition-all duration-300 hover:border-sakura-deep hover:-translate-y-1 hover:shadow-xl"
              >
                {/* Left accent line */}
                <div 
